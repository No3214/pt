...
const SEO_DESCRIPTIONS: Record<string, { title: string; description: string; keywords: string; locale: string }> = {
  tr: {
    ...
    description: 'ARENA ile bilimsel temelli, kişiye özel antrenman ve beslenme programları. Elit performans koçluk platformu.',
    keywords: 'personal training, voleybol antrenmanı, online koçluk, fitness, kişiye özel program, ARENA, performans platformu',
    locale: 'tr_TR',
  },
  en: {
    title: `${tenantConfig.brand.fullName} — Personalized Online Coaching`,
    description: 'Science-based, personalized training and nutrition programs on ARENA. The elite performance coaching platform.',
    keywords: 'personal training, volleyball training, online coaching, fitness, custom program, ARENA, performance platform',
    locale: 'en_US',
  },
  es: {
    title: `${tenantConfig.brand.fullName} — Entrenamiento Personal Online`,
    description: 'Programas de entrenamiento y nutrición personalizados con base científica en ARENA. Plataforma de coaching de alto rendimiento.',
    keywords: 'entrenamiento personal, voleibol, coaching online, fitness, programa personalizado, ARENA, plataforma de rendimiento',
    locale: 'es_ES',
  },
  fr: {
    title: `${tenantConfig.brand.fullName} — Coaching Personnel en Ligne`,
    description: 'Programmes d\'entraînement et de nutrition personnalisés sur ARENA. La plateforme de coaching de performance d\'élite.',
    keywords: 'entraînement personnel, volleyball, coaching en ligne, fitness, programme personnalisé, ARENA, plateforme de performance',
    locale: 'fr_FR',
  },
  de: {
    title: `${tenantConfig.brand.fullName} — Personalisiertes Online-Coaching`,
    description: 'Wissenschaftlich fundierte, personalisierte Trainings- und Ernährungsprogramme auf ARENA. Die Elite-Performance-Coaching-Plattform.',
    keywords: 'Personal Training, Volleyball, Online-Coaching, Fitness, individuelles Programm, ARENA, Performance-Plattform',
    locale: 'de_DE',
  },
  it: {
    title: `${tenantConfig.brand.fullName} — Coaching Personale Online`,
    description: 'Programmi di allenamento e nutrizione personalizzati su ARENA. La piattaforma di coaching ad alte prestazioni.',
    keywords: 'personal training, pallavolo, coaching online, fitness, programma personalizzato, ARENA, piattaforma di performance',
    locale: 'it_IT',
  },
  pt: {
    title: `${tenantConfig.brand.fullName} — Treinamento Personal Online`,
    description: 'Programas de treino e nutrição personalizados na ARENA. A plataforma de coaching de alto rendimento.',
    keywords: 'personal training, vôlei, coaching online, fitness, programa personalizado, ARENA, plataforma de performance',
    locale: 'pt_BR',
  },
  ru: {
    title: `${tenantConfig.brand.fullName} — Персональный Онлайн-Тренинг`,
    description: 'Научно обоснованные, персонализированные программы тренировок и питания на ARENA. Платформа элитного спортивного коучинга.',
    keywords: 'персональный тренинг, волейбол, онлайн-коучинг, фитнес, индивидуальная программа, ARENA',
    locale: 'ru_RU',
  },
  zh: {
    title: `${tenantConfig.brand.fullName} — 个性化在线教练`,
    description: '在 ARENA 上进行科学、个性化的训练和营养计划。精英表现教练平台。',
    keywords: '私人训练, 排球训练, 在线教练, 健身, 定制计划, ARENA, 表现平台',
    locale: 'zh_CN',
  },
  ja: {
    title: `${tenantConfig.brand.fullName} — パーソナライズドオンラインコーチング`,
    description: 'ARENA による科学に基づいた個別トレーニングと栄養プログラム。エリートパフォーマンスコーチングプラットフォーム。',
    keywords: 'パーソナルトレーニング, バレーボール, オンラインコーチング, フィットネス, カスタムプログラム, ARENA',
    locale: 'ja_JP',
  },
  ar: {
    title: `${tenantConfig.brand.fullName} — تدريب شخصي عبر الإنترنت`,
    description: 'برامج تدريب وتغذية مخصصة قائمة على العلم على منصة ARENA. منصة تدريب الأداء النخبوي.',
    keywords: 'تدريب شخصي, كرة طائرة, تدريب عبر الإنترنت, لياقة, برنامج مخصص, ARENA',
    locale: 'ar_SA',
  },
  ko: {
    title: `${tenantConfig.brand.fullName} — 맞춤형 온라인 코칭`,
    description: 'ARENA의 과학 기반 맞춤형 트레이닝 및 영양 프로그램. 엘리트 퍼포먼스 코칭 플랫폼.',
    keywords: '퍼스널 트레이닝, 배구, 온라인 코칭, 피트니스, 맞춤 프로그램, ARENA',
    locale: 'ko_KR',
  },
  hi: {
    title: `${tenantConfig.brand.fullName} — व्यक्तिगत ऑनलाइन कोचिंग`,
    description: 'ARENA पर विज्ञान-आधारित, व्यक्तिगत प्रशिक्षण और पोषण कार्यक्रम। एलीट प्रदर्शन कोचिंग प्लेटफॉर्म।',
    keywords: 'पर्सनल ट्रेनिंग, वॉलीबॉल, ऑनलाइन कोचिंग, फिटनेस, कस्टम प्रोग्राम, ARENA',
    locale: 'hi_IN',
  },
};
...
export default function SEO({
  title,
  description,
  canonical = 'https://arena.kozbeylikonagi.com.tr',
