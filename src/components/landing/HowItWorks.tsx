...
const STEPS_TR = [
  {
    num: '01',
    title: 'Başvuru & Tanışma',
    desc: 'Formu doldur, 15 dakikalık ücretsiz tanışma görüşmesinde hedeflerini ve seviyeni konuşalım.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Vücut analizin, hedeflerin ve spor geçmişine göre sana özel antrenman ve beslenme programı hazırlanır.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    num: '03',
    title: 'Dönüşüm Başlasın',
    desc: 'Haftalık check-in, video analiz ve sürekli optimizasyonla hedeflerine birlikte yürüyoruz.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const STEPS_EN = [
  {
    num: '01',
    title: 'Apply & Meet',
    desc: 'Fill in the form. In a free 15-minute intro call, we discuss your goals and current level.',
    icon: STEPS_TR[0].icon,
  },
  {
    num: '02',
    title: 'Custom Program',
    desc: 'Based on your body analysis, goals and training history, a personalized plan is crafted for you.',
    icon: STEPS_TR[1].icon,
  },
  {
    num: '03',
    title: 'Transform',
    desc: 'Weekly check-ins, video analysis and continuous optimization — we walk toward your goals together.',
    icon: STEPS_TR[2].icon,
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-8 md:px-12">
        <RevealSection className="text-center mb-24">
          ...
          <motion.h2 variants={fadeUp} custom={1}
            ...
            {language === 'tr' ? 'Üç adımda dönüşüm.' : 'Transform in three steps.'}
          </motion.h2>
