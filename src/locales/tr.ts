export const tr = {
  ...
  footer: {
    ...
    portal: {
      ...
      desc: "Disiplin, motivasyonun bittiği yerde başlar. Bugünün seçimleri, yarının zaferini belirler.",
      quote: "En zor antrenman, ilk adımı atandır. Sen o adımı çoktan attın.",
      ...
      gallery_toast_video_success: "Video koç onayına gönderildi! 🎥",
      export_title: "Kazanımlarını Paylaş",
    ...
    admin: {
      ...
      wellness_msg_warning: "Bugün biraz yorgun görünüyorsun. Antrenman yoğunluğunu %50 düşürelim veya mobiliteye odaklanalım. ⚠️",
      wellness_msg_safe: "Her şey harika görünüyor! Performansını korumaya devam et. 🔥",
      ...
      payments_subtitle: "Toplam gelir ve ödeme durumları",
      payments_total: "Toplam Gelir",
      ...
      macro_distribution_subtitle: "Sistem Genelindeki Ortalama",
      macro_protein: "Protein",
      macro_fat: "Yağ",
      macro_carbs: "Karbonhidrat",
      macro_unit: "gram"
    ...
    forms: {
      onboarding: {
        ...
        step1_desc: "Temel bilgilerini girerek başlayalım.",
        step2_title: "Fiziksel Durum.",
      ...
      measurement: {
        ...
        invalid_desc: "Lütfen antrenörünüzden yeni bir link talep edin.",
