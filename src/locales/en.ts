export const en = {
  ...
  howItWorks: {
    ...
    steps: [
      { num: "01", title: "Apply & Meet", desc: "Fill in the form. In a free 15-minute intro call, our team discusses your goals and current level." },
      { num: "02", title: "Custom Program", desc: "Based on your body analysis, goals and training history, a personalized plan is crafted by our experts." },
    ...
    items: [
      {
        ...
        name: "Ayşe K.", role: "Volleyball Player", metric: "+12cm jump", avatar: "/images/testimonials/ayse.png"
      },
      {
        text: "An injury-free, very strong season. The strength training is incredibly effective.",
        name: "Deniz Y.", role: "Professional Athlete", metric: "Zero Injury", avatar: "/images/testimonials/deniz.png"
      },
      {
        text: "Confidence and agility on the court leveled up. A program completely tailored to match performance.",
        name: "Selin B.", role: "Fitness & Volleyball", metric: "+8cm Mobility", avatar: "/images/testimonials/selin.png"
      }
    ]
  },
  programs: {
    ...
    items: [
      ...
      },
      {
        ...
        price: "350",
        period: "/mo",
        desc: "Professional athlete level — limited capacity (3 athletes/season)",
        features: ["Premium Growth included", "Weekly 2 1-on-1 video sessions", "On-court/gym physical measurement days", "Match and tournament periodization", "Injury return protocol", "Referral to Physio & RehabFit network", "Family/manager report", "Direct 24/7 WhatsApp line"],
        color: "accent",
        popular: false,
        anchor: true
      }
  ...
  faq: {
    ...
    title2: "answered.",
    items: [
      { q: "How do I start the program?", a: "After you fill out the application form, our expert team contacts you via WhatsApp. We discuss goals in a free 15-minute introductory call and determine the most suitable program." },
      ...
      { q: "Can I join if I don't play volleyball?", a: "Of course! Although the Volleyball Performance package is court-specific, Online Coaching and Premium Growth are suitable for all levels. We target strength, posture, and general fitness goals." },
  ...
  contact: {
    ...
    limitDesc: "Due to limited spots, we evaluate applications carefully. After you fill out the form, our team will contact you within 24 hours.",
    ...
    whatsappMsg: "Hello! I'm reaching out from the performance portal."
  },
  footer: {
    nav: "Navigation",
  ...
  portal: {
    ...
    macro_ai_placeholder: "E.g.: Ate 2 slices of whole wheat bread, 3 eggs and an omelet with plenty of cheese.",
    ...
    workout_not_found_desc: "Our team hasn't assigned a program yet.",
    ...
    gallery_desc: "Track your progress and send form videos to our coaches for technical analysis.",
    ...
    wellness_coach_wis: "Team Advice",
    ...
    roadmap_coach_msg_title: "A Message from the Team",
  ...
  admin: {
    ...
    wellness_msg_base: "Hello {name}! 👋 Our team has reviewed your daily wellness data. ",
    ...
    wellness_msg_warning: "Fatigue detected. Let's reduce training intensity by 50% or focus on mobility. ⚠️",
    ...
    login_hero_desc: "Welcome to your personal performance portal. Your workout plans, nutrition tracking, and progress analysis await you here.",
    ...
    login_testimonial_text: "Thanks to the portal, progress can be tracked much more clearly. My training plans are always up to date and personalized.",
    ...
    login_mode_login_subtitle: "Sign in to your performance portal",
  ...
  forms: {
    onboarding: {
      ...
      success_desc: "Our team will contact you via WhatsApp as soon as possible. Get ready!",
      ...
      note_label: "Note for Team",
      note_placeholder: "Anything you want to add...",
      kvkk_label: "Read and understood the privacy policy regarding the processing of all \"Sensitive Personal Data\", including health declarations, and explicit consent is given with free will.",
      terms_label: "Read and understood the Terms of Use and accepted that the training and diet programs are not medical advice, and any physical/health risk that may arise is entirely yours.",
      btn_next: "Next Step",
      btn_prev: "Back",
    ...
    measurement: {
      ...
      invalid_desc: "Please request a new link from our team.",
      ...
      note_placeholder: "Is there a note you want to add to the team?",
      disclaimer: "Committed to the accuracy of all measurement data entered. Training and nutrition guidelines do not replace medical treatment; user is obliged to seek professional medical support if necessary.",
  ...
  assessment: {
    ...
    email: {
      ...
      consent: "I consent to ARENA processing personal data and have read the privacy policy.",
      privacy: "Privacy Policy",
      submit: "Show Plan",
    ...
    questions: {
      goal: {
        ...
        choices: {
          performance: "Improve volleyball performance",
