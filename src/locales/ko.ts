export const ko = {
    ...
    cards: [
      {
        num: "01",
        title: "운동선수 규율",
        desc: "전문 배구 경험을 통해 증명된 훈련 방법론."
      },
      {
        num: "02",
        title: "개인적 강화",
        desc: "당신이 자신의 몸을 알고 당신의 목표와 일치하는 강한 기초를 구축하는 것이 제 목표입니다."
      },
      {
        num: "03",
        title: "선택적 프리미엄 추적",
        desc: "품질을 유지하기 위해 한정된 자리가 있는 일대일 중심 업무."
      }
    ]
  },
  howItWorks: {
    ...
    steps: [
      {
        num: "01",
        title: "지원 및 만나기",
        desc: "양식을 작성하십시오. 무료 15분 소개 통화에서 당신의 목표와 현재 수준을 논의합니다."
      },
      {
        num: "02",
        title: "맞춤형 프로그램",
        desc: "당신의 신체 분석, 목표 및 훈련 이력을 바탕으로 당신을 위해 개인화된 계획이 만들어집니다."
      },
      {
        num: "03",
        title: "변신",
        desc: "주간 점검, 비디오 분석 및 지속적인 최적화 — 함께 당신의 목표를 향해 나아갑니다."
      }
    ]
  },
  marquee: [
  ...
  faq: {
    ...
    items: [
      {
        q: "프로그램을 어떻게 시작하나요?",
        a: "신청서를 작성하시면 WhatsApp을 통해 연락드립니다. 무료 15분 소개 통화에서 목표를 논의하고 적절한 프로그램을 결정합니다."
      },
      {
        q: "온라인 트레이닝은 어떻게 진행되나요?",
        a: "맞춤형 프로그램이 영상 설명이 포함된 운동과 함께 앱을 통해 전송됩니다. 매주 체크인을 통해 폼을 확인하고 필요에 따라 프로그램을 업데이트합니다."
      },
      {
        q: "영양 계획이 포함되어 있나요?",
        a: "온라인 코칭에는 기본 영양 추적이 포함됩니다. 프리미엄 성장 패키지에는 TDEE에 따라 계산된 전체 영양 계획, 매크로 추적 및 1:1 영양 상담이 포함됩니다."
      },
      {
        q: "배구를 하지 않는데 참여할 수 있나요?",
        a: "물론입니다! 엘리트 배구 패키지는 코트 전용이지만, 온라인 코칭과 프리미엄 성장은 모든 수준에 적합합니다. 근력, 자세 및 일반적인 피트니스 목표에 집중합니다."
      },
      {
        q: "결과는 언제 볼 수 있나요?",
        a: "규율 있는 추적을 통해 처음 4주 이내에 눈에 띄는 변화가 시작됩니다. 진지한 변화는 3개월의 기간 동안 일어납니다. 일관성은 항상 결과를 가져옵니다."
      }
    ]
  },
  gallery: {
