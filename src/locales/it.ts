export const it = {
  ...
  footer: {
    ...
    admin: {
      ...
      progress_report_title: "Scheda di Progresso",
      total_measurements: "Misurazioni Totali",
      habit_score: "T. Abitudine",
      data_driven_title: "Prestazioni Basate sui Dati",
      data_driven_desc: "Questi grafici sono progettati per analizzare i dati bio-metrici e la costanza dell'atleta. Ogni misurazione ci aiuta a ottimizzare la nostra strategia.",
      btn_new_measurement: "Registra Nuova Misurazione",
      chart_weight_trend: "Tendenza Variazione Peso",
      chart_weight_subtitle: "Analisi Giornaliera su 12 Settimane",
      ...
      heatmap_consistency_label: "Costanza in 30 Giorni",
