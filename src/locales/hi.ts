export const hi = {
  ...
  assessment: {
    landingCTA: {
      badge: "2 मिनट",
      title: "अपना सबसे उपयुक्त प्रोग्राम खोजें",
      desc: "अपनी वॉलीबॉल पोजीशन, लक्ष्य और समय सारणी को मैप करें। 7 सवालों में हम Starter, Pro या Elite की सिफारिश करते हैं — आपके लिए तैयार।",
      cta: "निःशुल्क मूल्यांकन शुरू करें",
      meta: "कोई कार्ड नहीं · 2 मिनट · व्यक्तिगत योजना"
    },
    title: "ARENA मूल्यांकन",
    subtitle: "अपना सबसे उपयुक्त प्रोग्राम खोजने में 2 मिनट। आइए मिलकर आपकी प्रदर्शन कहानी लिखें।",
    progress: "{current} / {total}",
    cta: {
      start: "शुरू करें",
      next: "अगला",
      back: "वापस",
      submit: "मेरी योजना दिखाएँ",
      restart: "फिर से",
      book: "कॉल बुक करें"
    },
    email: {
      title: "अपनी योजना प्राप्त करें",
      subtitle: "हम परिणाम और व्यक्तिगत सिफारिशें आपके ईमेल पर भेजेंगे।",
      placeholder: "you@example.com",
      consent: "मैं ARENA द्वारा अपने व्यक्तिगत डेटा के प्रसंस्करण के लिए सहमति देता हूँ और गोपनीयता नीति पढ़ ली है।",
      privacy: "गोपनीयता नीति",
      submit: "मेरी योजना दिखाएँ",
      required: "ईमेल आवश्यक है",
      invalid: "एक मान्य ईमेल पता दर्ज करें"
    },
    questions: {
      goal: {
        label: "आपका मुख्य लक्ष्य क्या है?",
        choices: {
          performance: "अपना वॉलीबॉल प्रदर्शन सुधारें",
          national: "राष्ट्रीय टीम / पेशेवर करियर",
          rehab: "चोट के बाद सुरक्षित वापसी",
          fitness: "सामान्य फिटनेस + ताकत + आत्मविश्वास"
        }
      },
      age: {
        label: "आपकी आयु सीमा?",
        choices: { u14: "14 से कम", u18: "15–18", adult: "19–29", over30: "30+" }
      },
      position: {
        label: "आपकी वॉलीबॉल पोजीशन?",
        choices: {
          outside: "आउटसाइड हिटर",
          opposite: "ऑपोजिट",
          setter: "सेटर",
          middle: "मिडल ब्लॉकर",
          libero: "लिबरो",
          none: "मैं वॉलीबॉल नहीं खेलता"
        }
      },
      experience: {
        label: "आपका अनुभव स्तर?",
        choices: {
          beginner: "शुरुआती",
          recreational: "मनोरंजन / शौकिया",
          club: "क्लब / स्कूल टीम",
          elite: "प्रो लीग / राष्ट्रीय / अकादमी"
        }
      },
      frequency: {
        label: "आप सप्ताह में कितने दिन अभ्यास कर सकते हैं?",
        choices: { lt2: "2 दिन से कम", "2to3": "2–3 दिन", "4to5": "4–5 दिन", "6plus": "6+ दिन" }
      },
      injury: {
        label: "वर्तमान चोट की स्थिति?",
        choices: { none: "कोई चोट नहीं", past: "पिछली चोट, अब स्वस्थ", current: "अभी चोटिल" }
      },
      commitment: {
        label: "आप कितने महीने प्रतिबद्ध हो सकते हैं?",
        choices: { "1to3": "1–3 महीने", "4to6": "4–6 महीने", "6plus": "6+ महीने" }
      }
    },
    result: {
      title: "आपकी सबसे उपयुक्त योजना",
      starter: {
        name: "ARENA Starter",
        desc: "मजबूत नींव — पुनर्वास या संरचित प्रशिक्षण के पहले कदमों के लिए सुरक्षित।",
        price: "₺4,990 / माह",
        features: ["3-दिन साप्ताहिक प्रशिक्षण कार्यक्रम", "बुनियादी मूवमेंट मूल्यांकन", "पोषण गाइड", "1 मासिक 1-पर-1 कॉल", "WhatsApp समर्थन"]
      },
      pro: {
        name: "ARENA Pro",
        desc: "क्लब/स्कूल टीम प्रदर्शन — ताकत + शक्ति + सहनशक्ति।",
        price: "₺8,990 / माह",
        features: ["व्यक्तिगत 5-दिन कार्यक्रम", "पोजीशन-विशिष्ट ड्रिल लाइब्रेरी", "विस्तृत पोषण योजना + मैक्रो ट्रैकिंग", "साप्ताहिक 1-पर-1 कॉल", "माप + प्रगति रिपोर्ट"]
      },
      elite: {
        name: "ARENA Elite",
        desc: "प्रो / राष्ट्रीय पथ पर एथलीटों के लिए सबसे गहन 360° प्रदर्शन प्रणाली।",
        price: "₺17,990 / माह",
        features: ["6-दिन पीरियडाइज्ड प्रशिक्षण", "1-पर-1 तकनीकी + सामरिक विश्लेषण", "मासिक बायोमैकेनिकल वीडियो विश्लेषण", "2 साप्ताहिक 1-पर-1 + असीमित समर्थन", "खेल पोषण + सप्लीमेंट योजना", "मानसिक प्रदर्शन कोचिंग"]
      }
    }
  }
};
