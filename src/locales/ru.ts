export const ru = {
  ...
  legal: {
    ...
    terms_intro: "By using this website (arena-performance.com), you are deemed to have accepted the following terms of use. Please read these terms carefully.",
    terms_sections: [
      {
  ...
  assessment: {
    landingCTA: {
      badge: "2 МИНУТЫ",
      title: "Найди свою идеальную программу",
      desc: "Опиши свою позицию, цель и график в волейболе. За 7 вопросов мы рекомендуем Starter, Pro или Elite — персонально под тебя.",
      cta: "Начать Бесплатную Оценку",
      meta: "Без карты · 2 минуты · персональный план"
    },
    title: "Оценка ARENA",
    subtitle: "2 минуты, чтобы найти свою идеальную программу. Напишем вместе твою историю результатов.",
    progress: "{current} / {total}",
    cta: {
      start: "Начать",
      next: "Далее",
      back: "Назад",
      submit: "Показать Мой План",
      restart: "Пройти заново",
      book: "Записаться на звонок"
    },
    email: {
      title: "Получи свой план",
      subtitle: "Отправим результат и персональные рекомендации на твою почту.",
      placeholder: "ты@пример.com",
      consent: "Я согласен на обработку персональных данных ARENA и прочитал политику конфиденциальности.",
      privacy: "Политика конфиденциальности",
      submit: "Показать Мой План",
      required: "Email обязателен",
      invalid: "Введи действительный адрес email"
    },
    questions: {
      goal: {
        label: "Какая у тебя главная цель?",
        choices: {
          performance: "Улучшить свои результаты в волейболе",
          national: "Сборная / профессиональная карьера",
          rehab: "Безопасно вернуться после травмы",
          fitness: "Общая форма + сила + уверенность"
        }
      },
      age: {
        label: "Твой возрастной диапазон?",
        choices: { u14: "Младше 14", u18: "15–18", adult: "19–29", over30: "30+" }
      },
      position: {
        label: "Твоя позиция в волейболе?",
        choices: {
          outside: "Доигровщик",
          ...
          libero: "Либеро",
          none: "Не играю в волейбол"
        }
      },
      experience: {
        label: "Твой уровень опыта?",
        choices: {
          beginner: "Начинающий",
          recreational: "Любительский",
          club: "Клуб / школьная команда",
          elite: "Про-лига / сборная / академия"
        }
      },
      frequency: {
        label: "Сколько дней в неделю ты можешь тренироваться?",
        choices: { lt2: "Менее 2 дней", "2to3": "2–3 дня", "4to5": "4–5 дней", "6plus": "6+ дней" }
      },
      injury: {
        label: "Текущий статус травм?",
        choices: { none: "Нет травм", past: "Старая травма, восстановился", current: "Сейчас травмирован" }
      },
      commitment: {
        label: "Сколько месяцев готов посвятить?",
        choices: { "1to3": "1–3 месяца", "4to6": "4–6 месяцев", "6plus": "6+ месяцев" }
      }
    },
    result: {
      title: "Твой идеальный план",
      starter: {
        name: "ARENA Starter",
        desc: "Прочная база — безопасно для реабилитации или первых шагов в структурной тренировке.",
        price: "₺4 990 / мес",
        features: ["Недельная программа 3 дня", "Базовая оценка движения", "Гид по питанию", "1 персональный созвон в месяц", "Поддержка WhatsApp"]
      },
      pro: {
        name: "ARENA Pro",
        desc: "Результаты клубного/школьного уровня — сила + мощность + выносливость.",
        price: "₺8 990 / мес",
        features: ["Персональная программа 5 дней", "Библиотека упражнений по позиции", "Детальный план питания + макросы", "Еженедельный созвон 1-на-1", "Замеры + отчёт о прогрессе"]
      },
      elite: {
        name: "ARENA Elite",
        desc: "Самая интенсивная система 360° для атлетов на про/национальном пути.",
        price: "₺17 990 / мес",
        features: ["Периодизированная 6-дневная тренировка", "Технический + тактический анализ 1-на-1", "Ежемесячный видеобиомеханический анализ", "2 созвона/неделю + безлимитная поддержка", "План спортивного питания + добавки", "Коучинг ментальной производительности"]
      }
    }
  }
};
