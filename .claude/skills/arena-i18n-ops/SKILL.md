...
```tsx
{LOCALES.map(l => (
  <link key={l} rel="alternate" hrefLang={l} href={`https://arena.kozbeylikonagi.com.tr/${l}/`} />
))}
<link rel="alternate" hrefLang="x-default" href="https://arena.kozbeylikonagi.com.tr/" />
```
